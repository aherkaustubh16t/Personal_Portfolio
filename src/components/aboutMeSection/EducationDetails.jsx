...
const EducationCard = React.memo(({ edu, index }) => {
  ...
  return (
    ...
    >
      ...
      <div  whileHover="hover" variants={cardVariants} className="bg-gradient-to-br from-[#1f1f1f] to-[#2a2a2a] border-l-4 border-orange rounded-xl p-6 shadow-lg max-w-2xl mx-auto mb-8 ml-8 relative overflow-hidden group">
        {/* Background accent */}
